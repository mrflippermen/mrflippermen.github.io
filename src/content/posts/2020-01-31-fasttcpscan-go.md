...
classes: wide
header:
  teaser: /images/fasttcpscan-go/golang-go.png
...
![](/images/fasttcpscan-go/golang-go.png)
...
Actualmente tira por TCP, pero también se puede configurar para que vaya por UDP... de hecho no sería muy complicado si miráis el código, con unas pequeñas modificaciones ya lo tendríais, Â¡esa parte os la dejo a vosotros!.
